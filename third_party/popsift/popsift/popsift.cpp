    ...
    , _device(device)
{
    ...
    // bugfix: Mark Liu
    //
    // apply configuration triggers cuda runtime initialization. it is
    // called internally by extractDownloadLoop thread. this can cause
    // a deadlock if onnxruntime is also trying to initialize the cuda
    // runtime. so trigger it here (hopefully this is being called
